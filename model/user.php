...
class user extends registerModel{

    function getData($table, $field='', $condition_arr , $order_by_field='', $order_by_type='desc',$limit = ''){
    ...
    public function deleteData($table, $condition_arr ){
        ...
        if($condition_arr!=''){
            ...
            $result = $this->con()->query($sql); // delete id=4; 
    ...
    public function updateData($table, $condition_arr, $where_field, $where_value ){
        ...
        if($condition_arr!=''){
            ...
            //echo $sql;
            //return ;
            $result = $this->con()->query($sql); //  update your query ex: name,email;
